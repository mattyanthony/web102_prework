...
const message = `A total of $${totalRaised.toLocaleString()} has been raised for ${GAMES_JSON.length} games. ${
  numOfUnfundedGames === 1 ? "There is 1 unfunded game" : `There are currently ${numOfUnfundedGames} unfunded games. We need your help to fund these awesome games!`
}`;
